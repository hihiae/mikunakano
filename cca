...
function Update:Window(text,logo,keybind)
    ...
    BtnStroke.Color = Color3.fromRGB(63, 218, 58)
    ...
    function uitab:AddTab(text,img)
        ...
        BtnStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        BtnStroke.Color = Color3.fromRGB(55, 221, 78)
        BtnStroke.LineJoinMode = Enum.LineJoinMode.Round
        BtnStroke.Thickness = 1
        BtnStroke.Transparency = 0
        BtnStroke.Enabled = true
    ...
    function main:AddButton(text, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(68, 179, 46)
        ...
        Space.TextColor3 = Color3.fromRGB(127, 224, 36)
        Space.TextXAlignment = Enum.TextXAlignment.Right

        Black.Name = "Black"
        Black.Parent = Button
        Black.BackgroundColor3 = Color3.fromRGB(88, 211, 51)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        UIStroke.Color = Color3.fromRGB(20, 255, 118)
        ...
        Space.Text = "|"
        Space.TextSize = 15.000
        Space.TextColor3 = Color3.fromRGB(114, 190, 42)
        ...
        if default == true then
            ...
            game.TweenService:Create(
                ...
                {ImageColor3 = Color3.fromRGB(89, 207, 53)}
            ):Play()
            toggle = not toggle
            ...
            function()
                if toggle == false then
                    game.TweenService:Create(
                        ImageButton,
                        TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                        {ImageColor3 = Color3.fromRGB(162, 224, 47)}
                    ):Play()
                    ImageButton.ImageRectOffset = Vector2.new(4, 836)
                else
                    game.TweenService:Create(
    ...
    function main:AddDropdown(text,option,callback)
        ...
        UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        UIStroke.Color = Color3.fromRGB(70, 196, 45)
        UIStroke.LineJoinMode = Enum.LineJoinMode.Round
        UIStroke.Thickness = 1
        UIStroke.Transparency = 0
        UIStroke.Enabled = true
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderFrame.BackgroundColor3 = Color3.fromRGB(80, 209, 48)
        ...
        UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        UIStroke.Color = Color3.fromRGB(42, 199, 63)
        UIStroke.LineJoinMode = Enum.LineJoinMode.Round
        UIStroke.Thickness = 1
        UIStroke.Transparency = 0
        UIStroke.Enabled = true
        ...
        ImageLabel.BackgroundColor3 = Color3.fromRGB(81, 199, 46)
        ImageLabel.BackgroundTransparency = 1.000
        ImageLabel.BorderSizePixel = 0
        ...
        SliderInput.BackgroundColor3 = Color3.fromRGB(52, 209, 99)
        ...
        SliderButton.BackgroundColor3 = Color3.fromRGB(61, 255, 35)
        ...
        SliderCount.BackgroundColor3 = Color3.fromRGB(0, 255, 13)
        ...
        Title_2.BackgroundColor3 = Color3.fromRGB(45, 255, 3)
        ...
        BoxFrame.BackgroundColor3 = Color3.fromRGB(66, 255, 18)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        TextboxLabel.Name = "TextboxLabel"
        TextboxLabel.Parent = Textbox
        TextboxLabel.BackgroundColor3 = Color3.fromRGB(11, 255, 24)
        TextboxLabel.BackgroundTransparency = 1.000
        TextboxLabel.Position = UDim2.new(0, 15, 0, 0)
        TextboxLabel.Text = text
        TextboxLabel.Size = UDim2.new(0, 145, 0, 31)
        ...
        txtbtn.Name = "txtbtn"
        txtbtn.Parent = Textbox
        txtbtn.BackgroundColor3 = Color3.fromRGB(0, 255, 13)
        txtbtn.BackgroundTransparency = 1.000
        txtbtn.Position = UDim2.new(0, 1, 0, 1)
        txtbtn.Size = UDim2.new(0, 387, 0, 29)
        txtbtn.Font = Enum.Font.SourceSans
...
local M = Library:AddTab("Weapon")
local Ss = Library:AddTab("Stats")
local St = Library:AddTab("Setting")
local RaceV4 = Library:AddTab("Race V4")
local P = Library:AddTab("Pvp")
local R = Library:AddTab("Dungeon")
local T = Library:AddTab("Island")
local S = Library:AddTab("Shop")
local D = Library:AddTab("Fruit")
local Misc = Library:AddTab("Misc")



Main:AddSeperator("AutoFarm")


St:AddToggle("Auto Set Spawn Point",true,function(value)
    _G.Set = value
end)
...
task.spawn(function()
    ...
    Main:AddToggle("Auto Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
...
Main:AddToggle("Auto Chest (Fast)",false,function(vu)
	_G.ChestBypass = vu
end)
...
spawn(function()
    ...
    Main:AddToggle("Auto Cake Prince",_G.AutoDoughtBoss,function(value)
...
St:AddToggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
_G.BringMode = "Normal"
St:AddDropdown("Bring Mob Mode", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
St:AddToggle("Auto Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
    ...
    St:AddToggle("Fast Attack ",true,function(value)
        _G.FastAttack = value
    end)      
...
St:AddDropdown("Fast Attack Delay", AttackList,function(MakoGay)
...
St:AddToggle("Auto Click",false,function(value)
_G.AutoClick = value
end)

St:AddToggle("Remove Notifications Text",false,function(NamfonGay)
...
St:AddToggle("Remove Hit Sound And Level Up",false,function(Remo)
_G.RemoveHit = Remo
end)
...
spawn(function()
    ...
    St:AddToggle("Remove Attack",false,function(value)
...
spawn(function()
    ...
    spawn(function()
      ...
      if _G.WhiteScreen then
        ...
        St:AddToggle("White Screen",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    St:AddToggle("Invisible Monsters",_G.inv,function(value)
    _G.inv = value
    ...
    PosX = 0
    St:AddSlider("Pos X",0,50,0,function(value)
    PosX = value
    end)

    PosY = 30
    St:AddSlider("Pos Y",0,50,30,function(value)
    PosY = value
    end)

    PosZ = 0
    St:AddSlider("Pos Z",0,50,25,function(value)
    PosZ = value
    end)
    

    St:AddSeperator("Setting Mastery")
    
    _G.Kill_At = 25

    St:AddSlider("Kill At %",1,100,25,function(value)

        _G.Kill_At = value
    end)
    
 
    St:AddToggle("Skill Z",true,function(value)
        _G.SkillZ = value
    end)
 
    
    St:AddToggle("Skill X",true,function(value)
        _G.SkillX = value
    end)
    
    St:AddToggle("Skill C",true,function(value)
        _G.SkillC = value
    end)
    
    St:AddToggle("Skill V",true,function(value)
        _G.SkillV = value
    end)
...
M:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("Auto Drive Boat",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
M:AddToggle("Auto Tushita", _G.Autotushita,function(value)
    ...
    M:AddSeperator(" Sea baeat  ")
 
    M:AddToggle('Auto Sea baeat', false, function(value)
...
M:AddToggle('Auto Sea baeat Hop', false, function(value)
